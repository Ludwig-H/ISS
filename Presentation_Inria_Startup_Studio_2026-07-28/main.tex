...
\section{Technologie}
% Slide 4: La solution technique Percolia (3D LiDAR)
\begin{frame}{La solution technique Percolia (3D LiDAR)}
    \textbf{\bleu Une technologie issue de la recherche Inria}
    \begin{itemize}
        \item Logiciel de clustering non supervisé né des travaux de thèse de Louis \textsc{Hauseux} (Inria Sophia Antipolis).
    \end{itemize}

    \vspace{0.1cm}
    \textbf{\bleu Rupture technologique : HGP-Clusterer}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{\orange Piliers scientifiques :}
            \begin{itemize}
                \item \textbf{Ordre supérieur :} Hypergraphes pour mieux capturer la connectivité et la densité locale.
                \item \textbf{Percolation :} Retardement de la connectivité globale bloquant le bruit de mesure.
            \end{itemize}
        \end{column}
        
        \begin{column}{0.48\textwidth}
            \textbf{\orange Avantages clés :}
            \begin{itemize}
                \item \textbf{Training-Free :} Sans labellisation, robuste au changement de capteur.
                \item \textbf{Priors :} A priori géométriques (volumes, modèles) injectables.
                \item \textbf{Scalable :} Optimisé pour passer à l'échelle industrielle (ex. : 10~M de points).
            \end{itemize}
        \end{column}
    \end{columns}
...
% Slide 4a: La solution proposée Percolia (3D LiDAR)
\begin{frame}{La solution proposée Percolia (3D LiDAR)}
