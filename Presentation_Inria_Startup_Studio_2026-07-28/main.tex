...
\begin{frame}{La solution technique Percolia (3D LiDAR)}
    ...
    \begin{itemize}
        \item Une technologie issue des travaux de thèse de Louis \textsc{Hauseux} (Inria Sophia Antipolis).
    \end{itemize}
    ...
    \begin{block}{Publication de référence}
        \scriptsize
        \resizebox{\linewidth}{!}{L. \textsc{Hauseux}, K. \textsc{Avrachenkov}, J. \textsc{Zerubia}, «~Generalization of Single-Linkage with higher-order interactions~», \emph{Applied Network Science}, 2026.}
    \end{block}
\end{frame}
