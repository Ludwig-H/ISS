...
\date[28 Juillet 2026]{Mardi 28 Juillet 2026}
...
\section{Solutions (existante \& proposée)}
...
\begin{frame}{La Solution Percolia (3D LiDAR)}
    ...
    \begin{itemize}
        ...
        \item \textbf{Licence logicielle embarquée (local) :} Pour les contraintes fortes de confidentialité ou une intégration directe dans les logiciels de capteurs (ex. : \href{https://www.yellowscan.com/}{YellowScan}).
    \end{itemize}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.46\textwidth}
            ...
            \begin{block}{Publication de référence}
                \scriptsize
                L. \textsc{Hauseux}, K. \textsc{Avrachenkov}, J. \textsc{Zerubia}, «~Generalization of Single-Linkage with higher-order interactions~», \emph{Applied Network Science}, 2026.
            \end{block}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Une équipe complémentaire : Science \& Business}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \item Doctorat école STIC, option Informatique (Inria Sophia Antipolis).
    ...
    \begin{columns}[T]
        \begin{column}{0.6\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Crédibilité scientifique :} Gage d'excellence scientifique auprès des clients et des investisseurs.
            \end{itemize}
        \end{column}
