...
\begin{frame}[c]{Proposition de Valeur}
    \centering
    \Large
    \textbf{\bleu Percolia} propose un \textbf{\orange clustering 3D de haute précision} destiné aux \textbf{acteurs du LiDAR} (jumeaux numériques, robotique, construction navale, conduite autonome) pour isoler les \textbf{structures d'intérêt} du \textbf{bruit}.
\end{frame}
