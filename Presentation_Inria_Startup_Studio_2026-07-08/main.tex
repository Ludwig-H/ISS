...
\begin{frame}{Proposition de Valeur}
    \begin{center}
        \large
        \textbf{\bleu Percolia} propose une solution de \textbf{\orange clustering non supervisé 3D de haute précision} \\[6pt]
        destinée aux \textbf{acteurs exploitant des nuages de points LiDAR} \\
        \normalsize (jumeaux numériques, réseaux d'énergie, robotique mobile/SLAM, construction navale...) \\[6pt]
        \large
        pour \textbf{isoler de manière robuste les structures d'intérêt du bruit de mesure} \\
        \normalsize (feuillage, occlusions, poussières) sans nécessiter d'apprentissage ni d'étiquetage de données.
    \end{center}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{\bleu Notre promesse business}
                \begin{itemize}
                    \item \textbf{Gain de temps majeur} : Réduction drastique du nettoyage manuel des données.
                    \item \textbf{Agilité/Simplicité} : Intégration rapide sur les flux existants (training-free).
                \end{itemize}
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{block}{\bleu Domaines d'application cibles}
                \begin{itemize}
                    \item Jumeaux numériques \& Villes intelligentes
                    \item Suivi et monitoring d'infrastructures
                    \item Robotique autonome \& SLAM temps réel
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{API \& Licences :} vente d'abonnements et/ou à l'usage (API SaaS Cloud) ou de licences logicielles embarquées (Local/Offline).
            \end{itemize}
        \end{column}
