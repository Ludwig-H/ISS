...
\begin{frame}[c]{Proposition de Valeur}
    \centering
    \Large
    \textbf{\bleu Percolia} propose une solution de \textbf{\orange clustering non supervisé 3D de haute précision} destinée aux \textbf{acteurs exploitant des nuages de points LiDAR} pour isoler de manière robuste les \textbf{structures d'intérêt} du \textbf{bruit de mesure}.
\end{frame}
