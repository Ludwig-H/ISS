...
\begin{frame}{Exemple 1 : Détection d'anomalies de chantier (AIDetech)}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{\bleu Projet ISS (ex. Marie \textsc{Aspro}) avec Naval Group}
            \begin{itemize}
...
\begin{frame}{Exemple 2 : Jumeaux numériques urbains (Greehill)}
    \begin{columns}[T]
        ...
        \begin{column}{0.44\textwidth}
            ...
            \vspace{0.2cm}
            \tiny \textcolor{inria-2024-gris-bleu}{Images extraites d'une présentation de Gyula \textsc{Fekete} (CTO de Greehill). Légende : 1) segmentation sémantique \quad 2) segmentation d'instance \quad 3) résultat final}
        \end{column}
    \end{columns}
\end{frame}
